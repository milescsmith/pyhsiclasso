...
def test_regression(hsic_obj: HSICLasso, load_input_data: Callable[..., Any], input_data: Literal['matlab_data.mat'] | None, num_feat: int | None, test_b: int | None, test_m: int | None, expected_a: list[int] | None, load_covars: list[int]):
    if input_data:
...
def test_regression_non_divisor_block_size(hsic_obj: HSICLasso, load_input_data: Callable[..., Any], input_data: Literal['csv_data.csv']):
